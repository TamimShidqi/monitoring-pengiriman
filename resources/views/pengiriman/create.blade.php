                        ...
                        <div class="card card-primary">
                            ...
                            <div class="card-body">
                                <div class="form-group row">
                                    ...
                                    <select class="form-control ml-2" name="sopir_id" id="sopir_id" class="form-control"
                                        required>
                                        <option value="">Pilih Data Sopir</option>
                                        @foreach ($pengiriman as $data)
                                            <option value="{{ $data->sopir->id }}">{{ $data->sopir->nama }}</option>
                                            <option value="{{ $data->sopir->id }}">{{ $data->sopir->nama }}</option>
                                    </select>
                                </div>
                                <div class="form-group row">
                                    <label class="col-sm-2 col-form-label" for="mobil_id">Pilih Mobil</label>
                                    <select class="form-control ml-2" name="mobil_id" id="mobil_id" class="form-control"
                                        required>
                                        <option value="">Pilih Data Mobil</option>
                                        <option value="{{ $data->mobil->id }}">{{ $data->mobil->merk }}
                                            {{ $data->mobil->kapasitas }} Liter</option>
                                        @endforeach
                                    </select>
                                </div>
                                <div class="form-group row">
